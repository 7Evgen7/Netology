...
Надо определиться с доступом с `bastion` до всех наших ВМ и где будет запускаться `ansible`. Я буду запускать ансибл у себя, поэтому чтобы пройти бастион и оказаться на всех ВМ, в `~/.ssh/config` нужно указать proxy jump.
